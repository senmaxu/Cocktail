    ...
    <div id="content_for_layout" class="yhsd-base">
        <div class="wrapper log-block-outer">
            <div class="cont log-block-inner">
                <div class="log-block">
                    <h4 class="yhsd-font-title">通过手机找回密码</h4>

                        <form class="loginForm" id="" action="mima.html" method="post">
                           <center>
                            <div class="info">${error }</div>
                            <div class="inputbox" data-state="">
                                 <div class="title"></div>
                                      <input style="color: black;" type="text" name="phione" placeholder="请输入手机号或邮箱号查找" required/>
                                     <div class="tips"><h1></h1></div>
                            </div>                           
                              </center>                            
                         <button id="yhsd-login-submit" class="btn btn-primary btn-lg btn-block" type="submit">找回</button>
                        </form>
                </div>
            </div>
        </div>
