...
<head>
  ...
  <meta property="og:title" content="青丹" />
  ...
  <div class="cont">
    <div class="mod">
      <div class="blogs-wrapper">
        ...
        <div class="blogs-show clearfix lazyload_scope">
          <div id="blogs_show_left" class="blogs-show-left">
            <ul class="blogs-list"></ul>
          </div>
          <div id="blogs_show_right" class="blogs-show-right">
            <ul class="blogs-list"></ul>
          </div>
        </div>

        <ul id="blog_list_src" class="blogs-list blogs-list-org lazyload_scope">
          
          <li class="blogs-item settings-blogs_border" data-blogid="b000005">
...
<div class="blog_cont-info settings-blogs_border">
  <span class="blog_cont-info-author">
    ...
    <span class="blog_cont-info-time settings-blog_desc_color">2017-06-07 10:45</span>
  
</div>

          </li>
          
          <li class="blogs-item settings-blogs_border" data-blogid="b000004">
...
<div class="blog_cont-info settings-blogs_border">
  <span class="blog_cont-info-author">
    ...
    <span class="blog_cont-info-time settings-blog_desc_color">2017-06-07 10:44</span>
  
</div>

          </li>
          
          <li class="blogs-item settings-blogs_border" data-blogid="b000003">
...
<div class="blog_cont-info settings-blogs_border">
  <span class="blog_cont-info-author">
    ...
    <span class="blog_cont-info-time settings-blog_desc_color">2017-06-07 10:39</span>
          ...
          <li class="blogs-item settings-blogs_border" data-blogid="b000002">
            
            <a class="blogs-item-article settings-blog_desc_color" title="当轻博客遇见电商，生意优雅有温度" href="b000002.htm" >
              <div class="blogs-item-article-title settings-text_color">当轻博客遇见电商，生意优雅有温度</div>
              <div class="blogs-item-article-content settings-blog_desc_color">欢迎使用友好速搭，你看到的这个版块是轻博客功能，它能让你更好地展示和传播你的理念。现在简单介绍下这个功能，你可以新建4种轻博客内容：文字博客图片博客音乐博客视频博客友好速搭轻博客作为独立网站的功能之一，它将是实现你轻流量入口的重要一步。我们意在为你营造一个温暖的氛围，和冷冰冰的电商说再见。在做优雅有温度的生意的同时，写下你的故事，分享你的心情。让店铺中的每一件商品都赋有鲜活的生命力。将你的故事心情、优美的图片、有共鸣的音乐以及心动的视频随时随地分享至微博或朋友圈等平台，会有更多的人看到你和你独立</div>
            </a>
...
<div class="prolist-spfilter-pagenation">
  ...
  <span class="prolist-spfilter-pagenation-status">
      ...
      <a class="settings-text_color selected" href="/blogs?size=12&page=1">1</a>
...
// 博客展示
var oBlogsList = {
  leftEl : $('#blogs_show_left ul'),
  rightEl : $('#blogs_show_right ul'),
  srcEl : $('#blog_list_src'),
  init : function(){
    var self = this;
    self.setUl();
  ...
  setUl : function(){
    var self = this;
    var oSrcLi = self.srcEl.find('li');
    var bLeft = true;
    $.each(oSrcLi, function(index, oLi){
      var oNewLi = $(oLi).clone();
      if(bLeft){
        self.leftEl.append(oNewLi);
      }else{
        self.rightEl.append(oNewLi);
      }
      bLeft = !bLeft;
    });
  }
