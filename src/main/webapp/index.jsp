...
<ul id="top-nav-link" class="nav-link top-nav-link clearfix nav-link-left">
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957544" href="index.htm"  >首页</a>
    <!-- 二级菜单 -->
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957545" href="products.htm"  >在线商城</a>
    <!-- 二级菜单 -->
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957546" href="g000007.htm" >品酒文化</a>
    <!-- 二级菜单 -->
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957547" href="blogs.htm"  >品牌介绍</a>
    <!-- 二级菜单 -->
...
<ul class="top-nav-link nav-link nav-link-right clearfix">
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957548" href="g000003.htm"  >联系我们</a>
    <!-- 二级菜单 -->
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957549" href="products.htm" >品种介绍</a>
    <!-- 二级菜单 -->
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957550" href="blogs.htm"  >博客</a>
    <!-- 二级菜单 -->
    ...
    <li>
    <a class="txt-overflow settings-navLink_color settings-nav_border settings-navLinkHover_border" id="navlink_957551" href="products.htm"  >最新动态</a>
    <!-- 二级菜单 -->
...
<div class="wrapper wrapper-slide">
    <div class="slide">
      <div class="slide-inner settings-block_background">
        <div class="slide-cnt" id="slides">
          
          <a class="slide-link" href="p000007.htm" >
            <img width="100%" src="image/index_slide_1-v=1496994301.png"  alt="slide1"/>
          </a>
          
          
          <a class="slide-link" href="p000003.htm"  >
            <img width="100%" src="image/index_slide_2-v=1496635073.png"  alt="slide2"/>
          </a>
          
          
          <a class="slide-link" href="p000002.htm"  >
            <img width="100%" src="image/index_slide_3-v=1496734056.png" alt="slide3"/>
          </a>
...
<div class="wrapper clearfix wrapper-second">
  <a href="" >
      <img width="100%" src="image/index_big_pic_1-v=1496735835.png" alt="大图1"/>
    </a>
</div>
...
<div class="wrapper clearfix">
    <a class="third_pics" href="" >
      <img width="100%" src="image/index_third_pic_1-v=1496720549.png" alt="图片1"/>
    </a>
    <a class="third_pics" href="" >
      <img width="100%" src="image/index_third_pic_2-v=1496720549.png" alt="图片2"/>
    </a>
    <a class="third_pics" href="" >
      <img width="100%" src="image/index_third_pic_3-v=1496720550.png"  alt="图片3"/>
    </a>
    <a class="third_pics" href="" >
      <img width="100%" src="image/index_third_pic_4-v=1496720550.png"  alt="图片4"/>
    </a>
</div>
...
<div class="wrapper wrapper-fourth">
    <a href="" >
      <img width="100%" src="image/index_big_pic_2-v=1496734055.png"  alt="大图2"/>
    </a>
</div>
...
<div class="wrapper-fifth-title"><h2>鸡尾酒的故事</h2></div>
<div class="wrapper-story">
  <div><a href="products.htm" ><img src="image/index_story_pic_1-v=1496734057.png" ><div class="slide-content"><div><h2>当橙子遇见伏特加</h2><p>起初的鼻子，霍普斯普鲁尔（Hopus Primeur）揭示了坦率的跳跃音符和更微妙的大麻音符，其次是一丝苦涩和杏子。 在口中，它提供了风味和新鲜的爆炸：异国水果（黄色水果），罗勒和柑橘（橙色）。 它的品尝结束了非常漂亮和花卉完成。 它的苦涩是坦率而愉快的，有一个很好的，长时间的后苦味。 享受年轻和新鲜。<br/>尤其是唯一的作者瓶形是为了Delasy香槟。这似乎扭曲：她的颈部具有几个面，类似于螺旋形状，逐渐变细向上。本次展览“葡萄酒伏特加2013»，Delasy瓶香槟先后荣获大奖</p></div></div></a></div>
  <div><a href="products.htm"  ><img src="image/index_story_pic_2-v=1496997627.png" ><div class="slide-content"><div><h2>一丝大理石和白色的水果笔记</h2><p>一个“轻”，棕色的修道院啤酒，深红色的红色反射，巧克力，咖啡和甘草香气，还有一丝大理石和白色的水果笔记。<br/> 第一口是全味的，有一点酸度，提高了特殊麦芽提供的烤香味。 口味中味道鲜明。<br/>在Floreffe的修道院啤酒的最纯粹的传统中，瓶子二次发酵后，它有一个非常深的，几乎黑色的棕色头发。 鼻子，结合大茴香，甘草，烤香气和白色水果，是非常丰富和精致。 成分的力量从第一口味显而易见，用咖啡和烤可可豆味道表达。 啤酒坚固耐用，温暖而不是酒样，反对烤麦芽的微弱背景。 Floreffe Prima Melior拥有适度的酒精度和长期显着的酸性味，是一家鉴赏家的啤酒，复合而又易于使用。 存放在良好的条件下，大茴香笔记让位于木质，几乎成熟的笔记，成熟啤酒的爱好者必须。</p></div></div></a></div>
  <div><a href="products.htm"  ><img src="image/index_story_pic_3-v=1496734058.png" ><div class="slide-content"><div><h2>红色的回忆</h2><p>从芹菜茎中取出线，切成块。 将三文鱼切成碎片并用芹菜冲洗。 将一块碎的羊肉放在碗里，与鸡蛋混合。 将它们卷成小球，然后将它们压平。 在不粘锅中加热油，并在两侧炸鱼。 保持温暖。 将韭菜切成圆圈，冲洗并排出筛子。 熔化黄油在煎锅里搅拌炒韭菜。 添加原料，并允许在低热下烹饪15分钟。 必要时清洗混合物并筛分。 回到锅 加入啤酒，芥末和奶油，煮3〜4分钟。 季节用盐和胡椒调味。 将鱼蛋糕和酱汁放在预热的板上，伴着一杯不错的冰杯啤酒。</p></div></div></a></div>
</div>
  </div>
...
<script>
  ...
  <div class="cont">
    <div class="mod mobile_nav settings-nav_background">
      ...
      <a class="mobile_nav_logo settings-h1_color" href="index.htm" >
